...
#include "yuzu_audio_core/renderer/command/command_buffer.h"
#include "yuzu_audio_core/renderer/command/command_generator.h"
...
#include "yuzu_audio_core/renderer/effect/buffer_mixer.h"
#include "yuzu_audio_core/renderer/effect/capture.h"
#include "yuzu_audio_core/renderer/effect/effect_context.h"
#include "yuzu_audio_core/renderer/effect/light_limiter.h"
#include "yuzu_audio_core/renderer/mix/mix_context.h"
#include "yuzu_audio_core/renderer/performance/detail_aspect.h"
#include "yuzu_audio_core/renderer/performance/entry_aspect.h"
#include "yuzu_audio_core/renderer/sink/device_sink_info.h"
#include "yuzu_audio_core/renderer/sink/sink_context.h"
#include "yuzu_audio_core/renderer/splitter/splitter_context.h"
#include "yuzu_audio_core/renderer/voice/voice_context.h"
...
void CommandGenerator::GenerateBiquadFilterEffectCommand(const s16 buffer_offset,
    ...
    const auto& biquad_info = static_cast<const BiquadFilterInfo&>(effect_info);
    if (biquad_info.UsesFloatParameterFormat()) {
        const auto* parameter =
